package com.ascript.KappaMod.events;
...
import static com.ascript.KappaMod.KappaMod.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {
    
    public static final String ID = KappaMod.makeID("IdentityCrisisEvent");
            ...
            case 0:
                switch (i) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        imageEventText.loadImage("KappaModResources/images/events/IdentityCrisisEvent2.png");
